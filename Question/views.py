...
def leaderboard(request) :
    ...
    context["unsorted_users"] = Profile.objects.all()

    for userprofile in context["unsorted_users"] :
        based_on_rank = { userprofile : userprofile.marks }
    
    actual_lb = dict(sorted(based_on_rank))
    
    print(actual_lb)
    
    for rank,userprofile in actual_lb :
        userprofile.user_rank = rank
